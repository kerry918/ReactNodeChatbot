...
class Chatbot extends Component {
    ...
    constructor(props) {
        ...
        if (cookies.get('userID') === undefined) {
            // (cookie's name, the value we want to write in the cookie, set the cookie to be accessible in all pages)
    ...
    // two methods for text query and event query
    async df_text_query(text){
        ...
        // add previous messages to new array 
        ...
        if  (this.state.showBot){
            return (
                <div style={{ minheight: 500, maxHeight: 500, width: 400, position: 'absolute', bottom: 0, right: 0, border: '1px solid lightgrey'}}>
                    ...
                    <div id="chatbot" style={{ minheight: 388, maxHeight:388, widht: '100%', overflow: 'auto'}}>
